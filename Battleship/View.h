...
class View
{
	...
	const int FRINDLY_PORT_COLOR = Consola::CINZENTO;
	const int ENEMY_PORT_COLOR = Consola::AMARELO;
	const int FRIENDLY_SHIP_COLOR = Consola::VERDE;
	const int ENEMY_SHIP_COLOR = Consola::VERMELHO;
